...
export default function AboutStory() {
  ...
  const copy = {
    ...
    p4: {
      EN: "For over 20 years, Chef Surender has remained dedicated to serving Marrakech. Today, the group operates three interconnected destinations under the Bombay Darbar banner: the flagship modern Gueliz lounge, the high-atmosphere Medina Rooftop terrace overlooking the ancient sky, and a refined Casablanca outlet on Boulevard Ghandi. Despite competitor copycats, Chef Surender continues to manage every kitchen directly, ensuring that every curry retains its true, complex depth.",
      FR: "Depuis plus de 20 ans, le Chef Surender reste dévoué à Marrakech. Aujourd'hui, le groupe exploite trois adresses sous l'enseigne Bombay Darbar : le restaurant moderne de Gueliz, le toit-terrasse de la Médina, et notre adresse de Casablanca sur le Boulevard Ghandi. Malgré les tentatives de copie, le Chef Surender gère toujours chaque cuisine pour préserver l'authenticité de nos saveurs."
    },
        ...
        <div className="about-grid">
          ...
          <div className="about-image-column">
            <div className="about-img-frame glass-panel">
              <Image 
                src="/images/clay_pot_biryani.png" 
